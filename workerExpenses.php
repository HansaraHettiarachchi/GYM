...
<head>
    ...
    <title>Country Fitness Gymnasium | Expenses</title>
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title fs-6"><span class="fas fa-users mx-2"></span> Today Transaction Details. </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class=" col-12 mx-lg-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="text-center text-danger fw-bold my-4">Today Transaction Details</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless border border-2 border-dark">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $tot = 0;
                                                    $query = "SELECT * FROM `transactiondetails` WHERE `DAT` = ? ;";
                                                    $type = "s";
                                                    ...
                                                    for ($x = 0; $x < $rs_num; $x++) {
                                                        ...
                                                        if (strpos($rs_data['desc'], 'Last Month') !== 0) {
                                                    ?>
                                                            <tr>
